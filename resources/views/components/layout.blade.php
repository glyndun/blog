        ...
        <nav class="md:flex md:justify-between md:items-center">
            ...
            <div class="mt-8 md:mt-0 flex items-center space-x-4">
                ...
                @else
                    <x-dropdown>
                        <x-slot name="trigger">
                            <button class="text-xs font-bold mr-2">Welcome, {{ auth()->user()->name }}</button>
                        </x-slot>
                ...
                <a href="#newsLetter" class="bg-blue-500 rounded-full text-xs font-semibold text-white uppercase py-3 px-5">
